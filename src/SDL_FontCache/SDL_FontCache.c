...
static FC_StringList* FC_GetBufferFitToColumn(FC_Font* font, int width, FC_Scale, Uint8 keep_newlines)
{
...
Uint16 FC_GetPositionFromOffset(FC_Font* font, float x, float y, int column_width, FC_AlignEnum, const char* formatted_text, ...)
{
    FC_StringList *ls, *iter;
    Uint8 done = 0;
